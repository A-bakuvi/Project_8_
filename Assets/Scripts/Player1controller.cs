...
public class Player1controller : MonoBehaviour
{
    ...
    {
        var bullet1 = (GameObject)Instantiate(_bullet1, _bulletSpawner.transform.position, transform.rotation);
        bullet1.GetComponent<Rigidbody2D>().velocity = transform.up * _bulletSpeed;
        bullet1.transform.Rotate(offsetRotation);
        Destroy(bullet1, 1f);
    }*/
}
